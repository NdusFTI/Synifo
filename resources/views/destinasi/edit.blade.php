...
<div class="container py-4">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent px-0">
      ...
      <li class="breadcrumb-item"><a href="{{ route('destinasi.show', $destinasi->id) }}">{{ $destinasi->nama_destinasi }}</a></li>
        ...
        <div class="card-body">
          ...
          <form action="{{ route('destinasi.update', $destinasi->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama_destinasi" class="form-control form-control-lg" value="{{ old('nama_destinasi', $destinasi->nama_destinasi) }}" required>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  @if($destinasi->gambar_url)
                    <div class="mb-2">
                      <img src="{{ asset($destinasi->gambar_url) }}" alt="Current" class="img-thumbnail" style="max-height: 100px;">
