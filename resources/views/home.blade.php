...
<div class="container pb-5">
  <div class="row mb-4">
    ...
    <div class="col-md-3 mb-3">
      <div class="stat-card" style="background: linear-gradient(135deg, #FF69B4 0%, #FF85C1 100%);">
        <i class="bi bi-map"></i>
        <h2>{{ $totalLokasi }}</h2>
    ...
    <div class="col-md-3 mb-3">
      <div class="stat-card" style="background: linear-gradient(135deg, #66BB6A 0%, #81C784 100%);">
    ...
    <div class="col-md-3 mb-3">
      <div class="stat-card" style="background: linear-gradient(135deg, #FFA726 0%, #FFB74D 100%);">
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0"><i class="bi bi-star-fill text-warning"></i> Top Destinasi</h4>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4 mb-4">
                <div class="card destination-card h-100" onclick="window.location.href='{{ route('destinasi.show', $destinasi->id) }}'">
                  ...
                  @endif
                  <div class="card-body">
                    <h5 class="card-title mb-2">{{ $destinasi->nama_destinasi }}</h5>
                    <p class="card-text text-muted small mb-3">{{ substr($destinasi->deskripsi, 0, 100) }}...</p>
                    ...
                    <div>
                      <small class="text-muted"><i class="bi bi-pin-map text-danger"></i> {{ $destinasi->lokasi }}</small>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <h5 class="mb-3"><i class="bi bi-tags text-success"></i> Kategori Populer</h5>
          <div>
            @foreach($kategoriBadges as $kat)
              <span class="badge badge-primary mr-2 mb-2" style="font-size: 0.95rem; padding: 8px 15px;">
                {{ $kat['kategori'] }} <span class="badge badge-light ml-1">{{ $kat['total'] }}</span>
              </span>
            @endforeach
          </div>
        </div>
